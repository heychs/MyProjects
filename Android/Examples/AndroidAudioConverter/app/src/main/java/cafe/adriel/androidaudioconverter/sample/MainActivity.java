...
public class MainActivity extends AppCompatActivity {
    ...
    public void convertAudio(View v){
         ...
         */
        File wavFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/AudioConverter", "recorded_audio.wav");
        Log.d("AudioConverter", "External Storage Directory : " + Environment.getExternalStorageDirectory().getAbsolutePath() + "/AudioConverter");
